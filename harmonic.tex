...
\end{align*}
%
Next, by $\lambda$-harmonic definition, we may compute the Laplacian
as \Snote{ Note that this is the place where we are able to use
  differentiability whenever the arguments to phi are unequal, because
  the terms that might be non-differentiable are constant.}
\begin{align*}
