...
For some carefully chosen activation function, with regularization, at convergence of running the SGD algorithm, we learn at least one of the hidden weights of the target neural network.
\end{theorem}
%
