...
\begin{theorem}
Let $\mathcal{M} = S^1$ and $L$ be as in \eqref{errLossUnit} and $\sigma$ is the sign activation function. If Assumption \ref{outputFixed} holds, then $L$ admits no local minima, except at the global minima.
\end{theorem}
