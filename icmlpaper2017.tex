...
minima for these certain classes of potentials occur only when certain convergence statements hold. These potentials are often non-smooth, unbounded and un-realizable. However, in the later sections, we can show that approximations of these potentials can lead to similar convergence results. 
%
