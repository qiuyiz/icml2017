...
\Snote{Remove concepts not needed any more}
...
\end{restatable}
%
In the appendix~\ref{}, we prove a similar characterization for
rotationally invariant potentials.

\Snote{Richard, move this theorem, and all the rotationally invariant
