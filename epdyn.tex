...
of $w_j$ for some (or all) $j$. {\color{red} Although our loss is jointly
non-convex, it is quadratic in $\boldsymbol{a}$. Therefore we can
...
\end{definition}
%
\Snote{Note that the charges are fixed here.}
