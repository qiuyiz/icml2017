...
{\bf Remark}: Natural potentials satisfy $\Phi(\theta,\theta)$ {\it is
  a positive constant and we will also normalize
  $\Phi(\theta,\theta) = 1$ for the rest of the paper.} \Snote{What
  are natural potentials?  This is enforceable for rotationally
  symmetric realizeable potentials, but not necessarily for
  translationally invariant potentials, or other realizeable
  potentials.}
...
$a_1,...,a_k$.
\end{restatable} \Snote{Should this be $\frac{1}{2}\Phi$ instead? I
  think we should change all of it to define L with a factor of 1/2.}
