...
\label{thm:tranReal}
Let $\mathcal{M} = \R^d$ and $\Phi(\theta,w) = f(\theta - w)$ and $\Phi$ is integrable or square-integrable. Then, $\Phi$ is realizable if $\mathfrak{F}(f)(\omega) \geq 0$ and the corresponding activation
