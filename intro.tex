 ...
 \begin{tabular}{
   ...
   |p{\dimexpr.33\linewidth-2\tabcolsep-1.3333\arrayrulewidth}|% column 3
    ...
    \hline 
        ...
        Almost   $\lambda$-harmonic  & Complicated & Yes, Thm~\ref{nodeWise}\\
